        ...
        switch (element_data.type) {
            ...
            case 'blog_post':
                ...
                $(element_data.images).each(function(index, image_src) {
					...
					// The image, if expiration day, red X overlay
					html += '<div align="center" style="background-color:#DCDCDC;"><img src="'+image_src+'" style="max-width:250px;" /></div>';
                    
					// If effective date, green text overlay
					//if(element_data.onThisDate && element_data.onThisDate == "effects")
					//	html += '<div class="greenTxtOver">EFFECTIVE</div>';
					
					// If expiration date, red text overlay
					if(element_data.onThisDate && element_data.onThisDate == "expires")
						html += '<div class="redTxtOver">EXPIRES</div>';
					
					// The popup trigger layer
					if (SELF._options.lightbox)
